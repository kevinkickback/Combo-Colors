...
export const motionMap = (): MotionMap =>
	new Map([
		...
		[
			/\bhcb\.|\b63214(?![\d\.])/g,
			{
				source: `<svg viewBox="0 0 184 184" xmlns="http://www.w3.org/2000/svg"><g transform="matrix(-1 0 0 1 383.825 -327.476)"><path d="M244.682 427.03v-15l-32.915.002v4.506a78.189 78.189 0 002.71 23.748c12.89 48.946 70.304 75.688 117.346 48.53a80.002 80.002 0 0040.002-69.282v-.002-.044h12l19.966-25-20.035 25h13v.044c0 35.09-26.64 60.95-57.5 64.642l-.002.003a64.168 64.168 0 01-7.455.453v-.1h-.044c-5.98 0-11.694-.773-17.075-2.21-5.22-1.446-10.395-3.592-15.425-6.496a64.944 64.944 0 01-25.079-26.132 64.964 64.964 0 01-6.986-22.661z" fill="white"/><circle cx="-291.825" cy="-419.499" r="50" transform="rotate(180)" fill="red"/></g></svg>`,
				class: "motionIcon",
				alt: "HCB",
			},
		],
